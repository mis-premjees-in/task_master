<?php
	...
	if($thisMD5 != $prevMD5) {
		...
		setupTable('utedb', [
				"ALTER TABLE `utedb` DROP `utedb_what1`",
				"ALTER TABLE `utedb` DROP `utedb_who1`",
				"ALTER TABLE `utedb` DROP `utedb_when1`",
				"ALTER TABLE `utedb` DROP `utedb_which1`",
				"ALTER TABLE `utedb` DROP `utedb_where1`",
				"ALTER TABLE `utedb` DROP `utedb_why1`",
				"ALTER TABLE `utedb` DROP `utedb_howr1`",
				"ALTER TABLE `utedb` DROP `utedb_hows1`",
				"ALTER TABLE `utedb` DROP `utedb_howq1`",
				"ALTER TABLE `utedb` DROP `utedb_howt1`",
				"ALTER TABLE `utedb` DROP `utedb_why2`",
				"ALTER TABLE `utedb` DROP `utedb_why3`",
				"ALTER TABLE `utedb` DROP `utedb_where2`",
				"ALTER TABLE `utedb` DROP `utedb_where3`",
				"ALTER TABLE `utedb` DROP `utedb_which2`",
				"ALTER TABLE `utedb` DROP `utedb_which3`",
				"ALTER TABLE `utedb` DROP `utedb_when2`",
				"ALTER TABLE `utedb` DROP `utedb_when3`",
				"ALTER TABLE `utedb` DROP `utedb_who2`",
				"ALTER TABLE `utedb` DROP `utedb_who3`",
				"ALTER TABLE `utedb` DROP `utedb_what2`",
				"ALTER TABLE `utedb` DROP `utedb_what3`",
				"ALTER TABLE `utedb` DROP `utedb_howr2`",
				"ALTER TABLE `utedb` DROP `utedb_howr3`",
				"ALTER TABLE `utedb` DROP `utedb_hows2`",
				"ALTER TABLE `utedb` DROP `utedb_hows3`",
				"ALTER TABLE `utedb` DROP `utedb_howq2`",
				"ALTER TABLE `utedb` DROP `utedb_howq3`",
				"ALTER TABLE `utedb` DROP `utedb_howt2`",
				"ALTER TABLE `utedb` DROP `utedb_howt3`",
			]);
