...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV = [
		...
		"IF(    CHAR_LENGTH(`whos1`.`whos_who2`) || CHAR_LENGTH(`whos1`.`whos_description`), CONCAT_WS('',   `whos1`.`whos_who2`, '-', `whos1`.`whos_description`), '') /* Whos Id */" => "pnb_whos_id",
		"`pnb`.`pnb_delta_flag`" => "pnb_delta_flag",
		"`pnb`.`pnb_admin`" => "pnb_admin",
	...
	$x->QueryFieldsFilters = [
		...
		"IF(    CHAR_LENGTH(`whos1`.`whos_who2`) || CHAR_LENGTH(`whos1`.`whos_description`), CONCAT_WS('',   `whos1`.`whos_who2`, '-', `whos1`.`whos_description`), '') /* Whos Id */" => "Whos Id",
	...
	$x->ColCaption = ['Id', 'PnB Type', 'Premises Id', 'Whos Id', 'Delta Flag', 'Admin', 'Comments', 'Created AT', 'Updated AT', ];
	$x->ColFieldName = ['pnb_id', 'pnb_type', 'pnb_premises_id', 'pnb_whos_id', 'pnb_delta_flag', 'pnb_admin', 'pnb_comments', 'pnb_created', 'pnb_updated', ];
