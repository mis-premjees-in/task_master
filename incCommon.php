<?php
	...
	*/
	...
	function get_sql_fields($table_name) {
		$sql_fields = [
			...
			'pnb' => "`pnb`.`pnb_id` as 'pnb_id', `pnb`.`pnb_type` as 'pnb_type', `pnb`.`pnb_created` as 'pnb_created', `pnb`.`pnb_updated` as 'pnb_updated'",
		];
	...
	*/
	...
	function tablesWithAddNewInHomepage() {
		return ['madb','whats','whos','whens','whichs','wheres','whys','utedb',];
	}
