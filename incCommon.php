		...
		$pcConfig = [
			...
			'utedb' => [
				...
				'utedb_premises_id' => [
					...
					'child-primary-key' => 'utedb_id',
					'child-primary-key-index' => 0,
					'tab-label' => 'Universal TEDB <span class="hidden child-label-utedb child-field-caption">(Premises Id)</span>',
					'auto-close' => false,
					'table-icon' => 'table.gif',
					'display-refresh' => true,
					'display-add-new' => true,
